...
export default function Settings() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.bg }]}>
      <Text style={[styles.header, { color: theme.text }]}>⚙️ Cài đặt ứng dụng</Text>

      {/* Thông tin tài khoản */}
      <View style={[styles.card, { backgroundColor: theme.card }]}>
        <Text style={[styles.sectionTitle, { color: theme.text }]}>Thông tin tài khoản</Text>
        <Text style={[styles.text, { color: theme.text }]}>Tên: Đức</Text>
        <Text style={[styles.text, { color: theme.text }]}>Email: duc@example.com</Text>
      ...
      {/* Quyền riêng tư */}
      <View style={[styles.card, { backgroundColor: theme.card }]}>
        <Text style={[styles.sectionTitle, { color: theme.text }]}>Quyền riêng tư</Text>
      ...
      <View style={[styles.card, { backgroundColor: theme.card }]}>
        ...
        <Text style={[styles.text, { color: theme.text }]}>Phiên bản app: 1.0.0</Text>
        <Text style={[styles.text, { color: theme.text }]}>Liên hệ: support@example.com</Text>
      </View>

      {/* Đăng xuất */}
      <View style={[styles.card, { backgroundColor: theme.card, marginBottom: 50 }]}>
